...
gametest-Linux-Debug:
	 $(PROJECTBUILD) gametest Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

gametest-Linux-DebugGame:
	 $(PROJECTBUILD) gametest Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

gametest-Linux-Shipping:
	 $(PROJECTBUILD) gametest Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

gametest-Linux-Test:
	 $(PROJECTBUILD) gametest Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

gametest:
	 $(PROJECTBUILD) gametest Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

gametestEditor-Linux-Debug:
	 $(PROJECTBUILD) gametestEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

gametestEditor-Linux-DebugGame:
	 $(PROJECTBUILD) gametestEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

gametestEditor-Linux-Shipping:
	 $(PROJECTBUILD) gametestEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

gametestEditor-Linux-Test:
	 $(PROJECTBUILD) gametestEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

gametestEditor:
	 $(PROJECTBUILD) gametestEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
