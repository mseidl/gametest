...
unrealRootPath=/home/mseidl/src/UnrealEngine
gametestRootPath=/home/mseidl/src/gametest

gameProjectFile=/home/mseidl/src/gametest/gametest.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(gametestSource.pri)
include(gametestHeader.pri)
include(gametestConfig.pri)
include(gametestIncludes.pri)
include(gametestDefines.pri)
...
gametest-Linux-Debug.commands = $$build gametest Linux Debug  -project="\"$$gameProjectFile\"" $$args
gametest-Linux-DebugGame.commands = $$build gametest Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
gametest-Linux-Shipping.commands = $$build gametest Linux Shipping  -project="\"$$gameProjectFile\"" $$args
gametest-Linux-Test.commands = $$build gametest Linux Test  -project="\"$$gameProjectFile\"" $$args
gametest.commands = $$build gametest Linux Development  -project="\"$$gameProjectFile\"" $$args

gametestEditor-Linux-Debug.commands = $$build gametestEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
gametestEditor-Linux-DebugGame.commands = $$build gametestEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
gametestEditor-Linux-Shipping.commands = $$build gametestEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
gametestEditor-Linux-Test.commands = $$build gametestEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
gametestEditor.commands = $$build gametestEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	gametest-Linux-Debug \
	gametest-Linux-DebugGame \
	gametest-Linux-Shipping \
	gametest-Linux-Test \
	gametest \
	gametestEditor-Linux-Debug \
	gametestEditor-Linux-DebugGame \
	gametestEditor-Linux-Shipping \
	gametestEditor-Linux-Test \
	gametestEditor \
